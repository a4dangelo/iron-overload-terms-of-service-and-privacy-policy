<img width="2400" height="419" alt="Group 41" src="https://github.com/user-attachments/assets/95a9565b-56e8-484e-a9a5-03571a6dad9b" />

### Iron Overload
Last Updated: January 5th, 2026

#### 1. Introduction
Welcome to **Iron Overload** (“the App”). By downloading or using the App, you agree to this combined **Terms of Service & Privacy Policy** (“Agreement”). If you do not agree, please discontinue use of the App.

The App is intended **solely for informational and reference purposes** and is **not** a substitute for professional medical advice.

#### 2. Purpose of the App
The App provides general reference information only. It is **not** a medical device and does **not** provide medical advice, diagnosis, treatment, or recommendations.

Always consult a licensed physician or qualified healthcare provider for medical questions or decisions.
...
* You should consult your physician for any health‑related concerns.
...
Your privacy is important. This App is designed to operate **without collecting, storing, tracking, sharing, or transmitting any personal or usage data.**
...
All content, design, and functionality within the App are the property of **ADA Apps** and are protected by applicable copyright and intellectual property laws.
...
To the fullest extent permitted by law, **ADA Apps** shall not be liable for any damages arising from:
